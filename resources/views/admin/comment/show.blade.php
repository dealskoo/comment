...
@section('title',__('comment::comment.view_comment'))
@section('body')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">{{ __('comment::comment.view_comment') }}</li>
                    </ol>
                </div>
                <h4 class="page-title">{{ __('comment::comment.view_comment') }}</h4>
            </div>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="scope"
                                       ...
                                       max="{{ config('comment.max_score') }}" readonly>
                            </div>
                        </div>
                    </div> <!-- end row -->
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="comment" rows="4" name="comment"
                                          readonly>{{ old('comment',$comment->comment) }}</textarea>
                            </div>
                        </div> <!-- end col -->
                    </div> <!-- end row -->
                    <div class="row">
